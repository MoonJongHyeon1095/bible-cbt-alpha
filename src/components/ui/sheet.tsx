  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        ...
        // 애니메이션 클래스는 있어도 되고 없어도 됨(없어도 동작)
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        data-slot="sheet-content"
        className={cn(
          // ✅ content는 overlay보다 무조건 위: z-[60]
          // ✅ bg-background(변수 의존) 대신 bg-white 기본값
          "fixed z-[60] flex flex-col gap-4 shadow-xl bg-white text-slate-900",
          // 애니메이션(없어도 화면에 보여야 함)
