...
// type Props = {
//   // ✅ EmpathyCard처럼 감정+생각 그대로 보여주기 위해 둘 다 받음
//   emotionLabel: string;
//   thoughtText: string;

//   // ✅ as const(=readonly)로 넘어오므로 readonly로 받기
...
//   const rankPosMap = useMemo(() => {
//     const m = new Map<ErrorIndex, number>();
//     (ranked ?? []).forEach((x, i) => m.set(x.index, i + 1));
//     return m;
//   }, [ranked]);
...
//                       <p className="text-slate-900 mb-1 font-medium">
//                         {meta?.title ?? "인지오류"}
//                       </p>
...
//                           <p className="text-xs text-amber-600 mb-1">🔍 서술</p>
