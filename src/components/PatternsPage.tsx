...
import { TrendingUp, Plus, Trash2, Edit2, Save, X, AlertCircle, Lightbulb } from 'lucide-react';
    ...
    <div className="max-w-[1400px] mx-auto px-8 py-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600">반복되는 감정 패턴을 인식하고 관리하세요.</p>
        </div>
        {!isCreating && (
          <Button
      ...
      {patterns.length === 0 ? (
        <Card className="p-12 text-center">
          ...
          <p className="text-slate-500 text-lg mb-2">아직 저장된 패턴이 없습니다.</p>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-500 mb-1">💭 자동적 사고</p>
